...
write.table(resfixed,  "results/2_Bivar_Fixed_Effects_zero_fix.txt", row.names = F, sep = "\t", quote = F)
write.table(resrandom, "results/2_Bivar_Random_Effects_zero_fix.txt", row.names = F, sep = "\t", quote = F)
write.table(resVp,     "results/2_Bivar_Info_zero_fix.txt", row.names = F, sep = "\t", quote = F)
save(resvparam, file = "results/2_Bivar_Vparams_zero_fix.RData")
