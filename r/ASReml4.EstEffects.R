# Function to extract effect sizes and standard errors from animal models
...
asreml4estVp <- function(model1){
  ...
  cbind(eval(parse(text = paste0("vpredict(model1, Vp ~ ", vsum, ")"))), Effect = "Vp")
